...
- **[ask-agent](./ask-agent/SKILL.md)** — Find the right skill or flow for the current engineering/design situation.
...
- **[implement](./implement/SKILL.md)** — Implement a planned change from a PRD or issue set, using tests where possible.
...
- **[resolving-merge-conflicts](./resolving-merge-conflicts/SKILL.md)** — Resolve in-progress merge or rebase conflicts while preserving both sides' intent.
